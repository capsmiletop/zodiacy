              ...
              __html: `
                ...
                <div class="sib-form" style="text-align: center; background-color: transparent;">
                  <div id="sib-form-container" class="sib-form-container">
                    <div id="error-message" class="sib-form-message-panel" style="font-size:14px; text-align:left; font-family:Helvetica, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;max-width:400px;">
                    ...
                    <div></div>
                    <div id="success-message" class="sib-form-message-panel" style="font-size:14px; text-align:left; font-family:Helvetica, sans-serif; color:#085229; background-color:#e7faf0; border-radius:3px; border-color:#13ce66;max-width:400px;">
                      <div class="sib-form-message-panel__text sib-form-message-panel__text--center">
                        <svg viewBox="0 0 512 512" class="sib-icon sib-notification__icon">
                    ...
                    <div></div>
                    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(30, 35, 60, 0.5); max-width:400px; border-radius:3px; border-width:1px; border-color:rgba(255, 255, 255, 0.1); border-style:solid; direction:ltr; padding: 16px;">
                      <form id="sib-form" method="POST" action="https://135a3268.sibforms.com/serve/MUIFAIozC7a7_FW3dxdYYKxovIRL1a_BEK0dlzHLtWNGj_DKOICsBjQdC05Nyc4SIy-aOSd9rVgEI3LrEp5sd0Bs6dLKUBXUheEfJ5hg6fztTB3SSnTbvKrHw7pOR8fu9JWOamCV_gXlJdCz0F8xz26sRtDTioZ0cSwH5FcyThcHTgBG6CJF6j5_Qi3jY3h28_kuP9P00YvPmq8PXA==" data-type="subscription">
                        <div style="padding: 6px 0;">
                          <div class="sib-form-block" style="font-size:14px; text-align:left; font-weight:700; font-family:Helvetica, sans-serif; color:rgba(255, 255, 255, 0.9); background-color:transparent; text-align:left">
                              ...
                              <div class="form__label-row ">
                                <div class="entry__choice" style="">
                                  <label>
                                    ...
                                    <span class="checkbox checkbox_tick_positive" style="margin-left:"></span><span style="font-size:11px; text-align:left; font-family:Helvetica, sans-serif; color:rgba(255, 255, 255, 0.7); background-color:transparent;"><p>Accetto le condizioni generali e di ricevere novità e aggiornamenti da parte di Zodiacy.</p></span>
                                  </label>
                                </div>
                              </div>
                              <label class="entry__error entry__error--primary" style="font-size:14px; text-align:left; font-family:Helvetica, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;"></label>
                              <label class="entry__specification" style="font-size:10px; text-align:left; font-family:Helvetica, sans-serif; color:rgba(255, 255, 255, 0.5); text-align:left">Puoi annullare l'iscrizione in qualsiasi momento utilizzando il link incluso nella nostra newsletter. Utilizziamo Brevo come piattaforma di marketing. Inviando questo modulo, accetti che i dati personali da te forniti vengano trasferiti a Brevo.</label>
                            </div>
                          </div>
                        </div>
                        <div style="padding: 6px 0;">
                        ...
                        <div style="padding: 6px 0;">
                          <div class="sib-form-block" style="text-align: left">
                            <button class="sib-form-block__button sib-form-block__button-with-loader" style="font-size:13px; text-align:left; font-weight:700; font-family:Helvetica, sans-serif; color:#FFFFFF; background-color:rgba(255, 255, 255, 0.1); border-radius:3px; border-width:1px; border-color:rgba(255, 255, 255, 0.3); padding: 8px 16px;" form="sib-form" type="submit">
